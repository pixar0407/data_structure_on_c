...
void func(char *list, char* ans, int length, int *depth, char c); //recursion이 일어나는 함수
void main(void) {
...
void func(char *list, char* ans, int length, int *depth, char c) {//list불변, length 상수 || ans와 depth 변화
